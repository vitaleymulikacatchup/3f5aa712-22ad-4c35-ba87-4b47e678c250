...
export const metadata: Metadata = {
  title: "Black Coffee - Freshly Roasted Premium Coffee & Beverages",
  description: "Experience the perfect blend of flavor and aroma with our premium coffee selection, roasted fresh daily. Order online for delivery.",
  keywords: "coffee shop, freshly roasted coffee, espresso, latte, mocha, milkshakes, premium coffee beans, coffee delivery",
  openGraph: {
    title: "Black Coffee - Freshly Roasted Premium Coffee",
    description: "Experience the perfect blend of flavor and aroma with our premium coffee selection, roasted fresh daily.",
    ...
    images: [{
      ...
      alt: "Elegant stack of white porcelain cups on a clean, minimalist background. Perfect for café or home décor themes."
    }]
  },
  twitter: {
